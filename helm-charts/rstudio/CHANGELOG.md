...
# [4.2.0] - 2021-01-21
Update to use Rstudio image with libglpk-dev pre-installed.  

# [4.1.8] - 2021-01-11
Disable core dumps. 

# [4.1.7] - 2021-10-26
Update to use Rstudio image with python3-venv pre-installed. 

# [4.1.6] - 2021-09-23
Remove chown from RStudio - new versions point at EFS now so this is no longer needed (and it breaks Jupyter)

# [4.1.5] - 2021-09-21
Remove git config bits from RStudio
