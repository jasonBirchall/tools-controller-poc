...
- Renamed git config job to avoid clash with existing job

# [4.1.0] 2021-11-11

- Reverting git config job to pre-EKS configuration

# [4.0.0] 2021-11-11

- Deploying moj allspark jupyter notebook v2.1.0-rc1
- Reverted changes to EFS home volume to make this work on alpha
- NB this will break on the EKS clusters
